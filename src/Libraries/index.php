...
/*
Add config/app.php in providers:
    Fomvasss\Epochta\EpochtaServiceProvider::class,

Run command:
    php artisan vendor:publish

Find and edit file config/epochta_sms.php
*/
...
use Fomvasss\Epochta\Libraries\Stat;
 */


$sms_key_private = Config::get('epochta_sms.sms_key_private');
$sms_key_public = Config::get('epochta_sms.sms_key_public');
$url_gareway = Config::get('epochta_sms.url_gareway');
